...
const { addSocial, uploadPic, getSocial, updateSocial, updateSocialPic, deleteSocial } = require('../controllers/social');
const { addSocialValidation, updateSocialValidation } = require('../validations/social.validation');

router.get('/', getSocial)
router.post('/', uploadPic, validation(addSocialValidation), addSocial)
